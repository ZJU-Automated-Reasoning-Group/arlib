...
from pdsmt.utils.exceptions import ForAllSolverSuccess
...
class ForAllSolver:
    ...
    def check_model(self, raw_mappings: List[Tuple[str, int]]):
        ...
        sol = z3.Solver()
        sol.add(z3.Not(sub_phi))  # z33.Not(sub_phi) is the condition to be checked/solved

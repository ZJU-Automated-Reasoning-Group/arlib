...
def shorten_strategy(strategy):
    """ Pop tactic from the end of strategy and return tuple consisting of
    remaining strategy and single tactic. """
...
def head_strategy(strategy):
    """ Pop tactic from the beginning of strategy and return tuple consisting of
    single tactic and remaining strategy. """
    tactics = get_tactics(str(strategy))
    if len(tactics) == 1:

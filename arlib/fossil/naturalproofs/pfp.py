...
from arlib.fossil.naturalproofs.uct import get_uct_sort
from arlib.fossil.naturalproofs.decl_api import get_recursive_definition
from arlib.fossil.naturalproofs.utils import transform_expression

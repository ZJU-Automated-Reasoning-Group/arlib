adt ArrayList {
    Empty { }
	Add { ArrayList l; HashNode e; }
    Set { ArrayList l; int idx; HashNode e; }
...
void rewrite_Get(ArrayList l, int idx, ref HashNode ret) {
    switch(l) {
        case Empty: { ret = null; }
        case Add: {
            int j;
...
void rewrite_Copy(ArrayList l, ref ArrayList ret) {
    switch(l) {
        ...
        case Set: {
            ...
            rewrite_Copy(l.l, ret_l);
            node_copy(l.e, ret_e);
            ret = new Set(l = ret_l, idx = l.idx, e = ret_e);
        }
        case Remove: {
            ArrayList ret_l;
...
void list_add(ArrayList l, HashNode e, ref ArrayList ret) {
    ret = new Add(l = l, e = e);
}

void list_get(ArrayList l, int idx, ref HashNode ret) {
    rewrite_Get(l, idx, ret);
}

void list_set(ArrayList l, int idx, HashNode e, ref ArrayList ret) {

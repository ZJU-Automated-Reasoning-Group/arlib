...
from arlib.quant.fossil.naturalproofs.decl_api import get_recursive_definition, get_all_axioms, is_expr_fg_sort
from arlib.quant.fossil.naturalproofs.utils import Implies_as_FuncDeclRef
import arlib.quant.fossil.naturalproofs.proveroptions as proveroptions
from arlib.quant.fossil.naturalproofs.prover_utils import make_recdef_unfoldings, get_foreground_terms, instantiate, get_recdef_applications

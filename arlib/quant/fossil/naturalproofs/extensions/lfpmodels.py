...
from arlib.quant.fossil.naturalproofs.uct import fgsort, boolsort, intsort
from arlib.quant.fossil.naturalproofs.decl_api import get_vocabulary, get_uct_signature, get_recursive_definition, get_all_axioms
from arlib.quant.fossil.naturalproofs.utils import apply_bound_formula
from arlib.quant.fossil.naturalproofs.prover_utils import instantiate, make_recdef_unfoldings

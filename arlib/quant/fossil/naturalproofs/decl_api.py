...
import z3
from arlib.quant.fossil.naturalproofs.uct import UCTSort, is_expr_fg_sort, boolsort
from arlib.quant.fossil.naturalproofs.AnnotatedContext import AnnotatedContext, default_annctx
